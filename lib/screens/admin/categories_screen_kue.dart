...
import 'package:pdp_wisatakuliner/podo/kategori_kue_services.dart';
import 'package:pdp_wisatakuliner/screens/admin/categories_cepat_saji.dart';
...
class CategoriesKue extends StatefulWidget {
  @override
  _CategoriesKueState createState() => _CategoriesKueState();
}

class _CategoriesKueState extends State<CategoriesKue> {
  String catie = "Makanan Kue";
  List<Kue> _kue;
        ...
        child: ListView(
          children: <Widget>[
            ...
            GridView.builder(
              ...
              itemCount: _kue == null ? 0 : _kue.length,
