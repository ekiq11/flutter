...
class ProductFavDetails extends StatefulWidget {
  ...
  ProductFavDetails(
      ...
      @required this.img,
      @required this.isFav,
      @required this.jmlRating})
      : super(key: key);

  @override
  _ProductFavDetailsState createState() => _ProductFavDetailsState();
}

class _ProductFavDetailsState extends State<ProductFavDetails> {
  String catie = "Makanan Cepat Saji", id = "", komentar;
  bool isFav = false;
  double jmlRating = 3;
